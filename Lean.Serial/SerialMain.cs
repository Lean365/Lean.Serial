...
namespace Lean.Serial
{
    ...
    public partial class SerialMain : Form
    {
        ...
        private void SerialMain_Load(object sender, EventArgs e)
        {
            ...
            DateTime updatetime = DateTime.Now; //DateTime.Now.AddDays(-1);//
            string sdate = updatetime.AddDays(-(updatetime.Day) + 11).ToString("yyyyMMdd");
            string edate = updatetime.AddDays(-(updatetime.Day) + 25).ToString("yyyyMMdd");
            //string sdate = updatetime.ToString("yyyyMMdd");
            //string edate = updatetime.ToString("yyyyMMdd");

            //stime = sdate + "0000";
            //etime = edate + "2345";
            //GetSerialData();

            bool resultBool = getTimeSpan(updatetime.ToString("yyyy-MM-dd HH:mm:ss"));
            //getResult = Convert.ToString(resultBool);
            if (resultBool == false)
            {
                //etime = sdate + "000000";
                //etime = edate + "230000";
                stime = updatetime.ToString("yyyyMMdd") + "133001";
            ...
            else
            {
                //etime = sdate + "000000";
                //etime = edate + "230000";
                stime = updatetime.ToString("yyyyMMdd") + "080000";
                etime = updatetime.ToString("yyyyMMdd") + "133000";
                GetSerialData();
